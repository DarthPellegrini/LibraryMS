...
public class EventoHome {
	...
	public Evento findById(int id) {
		...
		try {
			Evento instance = (Evento) sessionFactory.getCurrentSession().get("Evento", id);
			if (instance == null) {
	...
	public List<Evento> findByExample(Evento instance) {
		...
		try {
			List<Evento> results = (List<Evento>) sessionFactory.getCurrentSession().createCriteria("Evento")
