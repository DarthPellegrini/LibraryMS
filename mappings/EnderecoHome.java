...
public class EnderecoHome {
	...
	public Endereco merge(Endereco detachedInstance) {
		...
		try {
			Endereco result = (Endereco) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Endereco findById(int id) {
		...
		try {
			Endereco instance = (Endereco) sessionFactory.getCurrentSession().get("Endereco", id);
			if (instance == null) {
	...
	public List<Endereco> findByExample(Endereco instance) {
		...
		try {
			List<Endereco> results = (List<Endereco>) sessionFactory.getCurrentSession().createCriteria("Endereco")
